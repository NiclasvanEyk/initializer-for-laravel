<div class="flex justify-center items-center mb-16 pt-4 sm:justify-start">
    <a href="/" class="flex flex-row items-center">
        ...
        <span class="mt-[2px] dark:text-gray-300 text-2xl select-none">Initializer</span>
        <span class="mt-[2px] dark:text-gray-300 text-2xl select-none hidden sm:block">&nbsp;for</span>
