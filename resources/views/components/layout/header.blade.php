<div class="flex justify-center items-center mb-16 pt-4 sm:justify-start">
    <a href="/" class="flex flex-row items-center">
        <svg
            class="h-11 width-auto mr-3"
            viewBox="0 0 271 279.01501"
        ...
        <span class="mt-[2px] font-bold dark:text-gray-300 text-2xl select-none">Initializer</span>
        <span class="mt-[2px] font-bold dark:text-gray-300 text-2xl select-none hidden sm:block">&nbsp;for</span>
        <svg class="h-10 w-auto hidden sm:block" viewBox="0 0 700 300">
            <g>
                <polygon style="fill:#FF2D20;" points="82.8,79.626 60.019,79.626 60.019,218.301 125.592,218.301 125.592,197.897 82.8,197.897
            "/>
                <path style="fill:#FF2D20;" d="M206.02,138.464c-2.906-4.622-7.033-8.253-12.382-10.896c-5.348-2.641-10.731-3.963-16.145-3.963
            ...
            C206.02,176.104,205.358,179.868,204.039,183.434z"/>
                <path style="fill:#FF2D20;" d="M381.542,138.464c-2.906-4.622-7.033-8.253-12.382-10.896c-5.348-2.641-10.731-3.963-16.145-3.963
            c-7.003,0-13.407,1.288-19.217,3.863c-5.813,2.575-10.797,6.111-14.957,10.6c-4.16,4.491-7.397,9.675-9.707,15.55
            c-2.313,5.879-3.467,12.055-3.467,18.524c0,6.606,1.154,12.811,3.467,18.621c2.309,5.814,5.546,10.964,9.707,15.453
            c4.16,4.491,9.145,8.023,14.957,10.598c5.81,2.575,12.214,3.863,19.217,3.863c5.414,0,10.797-1.321,16.145-3.962
            ...
            C381.542,176.104,380.88,179.868,379.562,183.434z"/>
                <rect x="618.426" y="79.626" style="fill:#FF2D20;" width="21.593" height="138.675"/>
                <polygon style="fill:#FF2D20;" points="244.652,218.301 266.244,218.301 266.244,147.23 303.291,147.23 303.291,125.984
            244.652,125.984 	"/>
                <polygon style="fill:#FF2D20;" points="489.709,125.984 462.569,196.678 435.428,125.984 413.558,125.984 449,218.301
            476.138,218.301 511.579,125.984 	"/>
                <path style="fill:#FF2D20;" d="M558.675,123.61c-26.442,0-47.372,21.73-47.372,48.534c0,29.63,20.256,48.534,50.139,48.534
    ...
    <nav class="mr-4 flex flex-row items-center dark:text-gray-500 space-x-4">
        <x-link
            href="https://github.com/sponsors/NiclasvanEyk"
...
{{--                class="border rounded-md py-2 px-4 transition hover:bg-gray-100 duration-200"--}}
